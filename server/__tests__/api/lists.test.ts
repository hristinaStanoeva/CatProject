...
describe('/api/lists', () => {
    [
        ...
        it('POST / should return 400 when title is ' + v.stringValue, async () => {
            const result = await request(app).post('/api/lists').send({
                title: v.testValue
            });
    ...
    [
        ...
        it('PUT / should return 400 when title is ' + v.stringValue, async () => {
            const result = await request(app).put('/api/lists/1').send({
                title: v.testValue
            });
